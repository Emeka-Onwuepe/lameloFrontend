...
const ProductCard = ({ products, prices, toppings }) => {
    ...
    return (
        <Container>
            ...
            <Row>
                {toppings.length > 0 ? <div style={{ textAlign: 'center', backgroundColor: '#4CAF50', zIndex: '1000', border: '3px solid #4CAF50', padding: '20px', marginBottom: '10px' }} className="toppings-style">
